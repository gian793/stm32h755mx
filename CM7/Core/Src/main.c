...
osThreadId_t logM7TaskHandle;
const osThreadAttr_t logM7Task_attributes = {
  .name = "logM7Task",
  .stack_size = 1024,
  .priority = (osPriority_t) osPriorityLow,
};

osThreadId_t testCppTaskHandle;
const osThreadAttr_t cppTestTask_attributes = {
  .name = "cppTestTask",
  .stack_size = 1024,
  .priority = (osPriority_t) osPriorityLow1,
};

osThreadId_t testCsimpleTaskHandle;
const osThreadAttr_t cSimpleTask_attributes = {
  .name = "cSimpleTestTask",
  .stack_size = 1024,
  .priority = (osPriority_t) osPriorityLow1,
};


osThreadId_t extChCmdTaskHandle;
const osThreadAttr_t extChCmdTask_attributes = {
  .name = "extChCmdTask",
  .stack_size = 1024,
...
void vHeartBeatTask( void* pArgument );

/*---------------------------------------------------------------------------*/

extern void vLogM7Task( void* pArgument );

extern void vCppTestTask( void* pArgument );
extern void vCsimpleTask( void* pArgument );
extern void vExtChCmdTask( void* pArgument );
